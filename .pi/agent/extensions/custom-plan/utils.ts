/**
 * Pure utility functions for custom plan mode.
 * Command safety checks for read-only bash enforcement.
 */
...
const SAFE_PATTERNS = [
	...
	/^\s*bat\b/,
	/^\s*eza\b/,
	// Allow --help, -h, --version, man for info gathering
	/--help\b/,
	/-h\b/,
	/--version\b/,
	/^\s*man\b/,
	// Allow mkdir only for plans/ directory
